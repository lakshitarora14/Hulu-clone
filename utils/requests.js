...
const  fetchAPIs =  {
    ...
    fetchMystery :{
        title: 'Mystery',
        url: `discover/movie?api_key=${API_KEY}&language=en-US&with_genre=9648`
    },
    fetchSciFi :{
        title: 'Sci-fi',
        url: `discover/movie?api_key=${API_KEY}&language=en-US&with_genre=878`
    },
    fetchWestern :{
        title: 'Western',
        url: `discover/movie?api_key=${API_KEY}&language=en-US&with_genre=37`
    },
    fetchAnimation :{
        title: 'Animation',
    ...
    fetchTV :{
        title: 'TV Movie',
        url: `discover/movie?api_key=${API_KEY}&language=en-US&with_genre=10770`
    }
}
